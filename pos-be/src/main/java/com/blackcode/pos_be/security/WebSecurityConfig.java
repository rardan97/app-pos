package com.blackcode.pos_be.security;

import com.blackcode.pos_be.security.jwt.AuthEntryPointJwt;
...
public class WebSecurityConfig {
    ...
    public WebSecurityConfig(PetugasDetailsServiceImpl petugasDetailsService,
    ...
    @Bean
    public DaoAuthenticationProvider petugasDaoAuthenticationProvider() {
        DaoAuthenticationProvider authProvider = new DaoAuthenticationProvider();
        authProvider.setUserDetailsService(petugasDetailsService);
    ...
    public AuthenticationManager authenticationManager() {
        return new ProviderManager(List.of(petugasDaoAuthenticationProvider()));
